...
export default function HomePage() {
  return <main className="site-shell home-page">
    <header className="site-header">
      ...
      <nav aria-label="Primary navigation"><Link href="/national-trust-listings">National Trust Register</Link><Link href="/kenmore-advocacy">Kenmore Advocacy</Link><Link href="/media-articles">Media Articles</Link><Link href="/kenmore-history">History of Kenmore</Link><Link href="/research">Research</Link><a href="#about">About the project</a></nav>
    </header>
