    ...
    <article className="record">
      ...
      <div className="record-layout">
        <div className="record-main">
          ...
          <section><h2>Photographic study of Kenmore, 2020</h2><p><a className="external-link" href="https://lostcollective.com/collections/kenmore-asylum" target="_blank" rel="noreferrer">Lost Collective: Kenmore Asylum</a> — a photographic study of Kenmore in 2020, documenting the decay of its heritage buildings.</p></section><section><h2>Wikipedia Entry</h2><p><a className="external-link" href="https://en.wikipedia.org/wiki/Kenmore_Hospital" target="_blank" rel="noreferrer">Kenmore Asylum</a></p></section>
        </div>
